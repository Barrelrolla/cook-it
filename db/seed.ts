...
export async function seed(additionalRecipes?: boolean) {
  ...
  if (additionalRecipes) {
    await db.insert(recipeTable).values([
      ...
      },
      {
        ...
        difficulty: "medium",
        instructions: [
          "Arrange crispy chicken over cooked rice and vegetables.",
        ],
      ...
      },
      {
        ...
        difficulty: "easy",
        instructions: [
          "Toss cooked pasta with lemon juice and sautéed garlic.",
        ],
      ...
      },
      {
        ...
        difficulty: "easy",
        instructions: [
          "Brush the salmon with honey and chili before roasting.",
        ],
      ...
      },
      {
        ...
        difficulty: "easy",
        instructions: [
          "Roast the vegetables until browned and serve over rice.",
        ],
      ...
      },
      {
        ...
        difficulty: "hard",
        instructions: [
          "Bake the chocolate base and top it with chilled mousse.",
        ],
